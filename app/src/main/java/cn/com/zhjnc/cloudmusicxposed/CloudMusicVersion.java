...
public class CloudMusicVersion {
    ...
    public static String MALL_ENTRANCE_METHOD = "m";
    //public static String AD_CLASS             = PACKAGE + ".module.ad.c";
    //public static String AD_METHOD            = "a";
    public static String AD_FRAGMENT          = PACKAGE + ".fragment.ax";
    ...
    public static String MUSIC_INFO_CLASS     = PACKAGE + ".meta.MusicInfo";
    ...
    public static String VIP_LRC_IMAGE_CLASS  = PACKAGE + ".module.lyrictemplate.d";
    public static String ABOUT_CLASS          = PACKAGE + ".activity.AboutActivity";
    public static String ABOUT_METHOD         = "ac";
    ...
    public static String DAILY_RCMD_FRAGMENT  = PACKAGE + ".fragment.DailyRcmdMusicFragment";
    ...
    public static String SEARCH_AD_CLASS        = PACKAGE + ".ui.AdBannerView";
    public static String COMMENT_AD_CLASS       = PACKAGE + ".fragment.s$1";
    public static String COMMENT_LIST_ENTRY     = PACKAGE + ".meta.virtual.CommentListEntry";
